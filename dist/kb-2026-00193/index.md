...
atomic_facts:
  - id: fact-computer-science-001
    statement: >-
      Linear algebra is the mathematics of vectors and matrices, fundamental to computer graphics, machine learning (neural networks), physics simulation, and data science. Core concepts: vectors,
      matrices, linear transformations, determinants, eigenvalues/eigenvectors, linear systems.
...
primary_sources:
  - title: ACM Digital Library
    ...
    institution: ACM
  - title: Linear Algebra Done Right (5th Edition, 2025)
    type: book
    year: 2025
    authors:
      - Axler S.
    institution: Springer
    url: https://doi.org/10.1007/springer.2025.la
  - title: Matrix Analysis and Applied Linear Algebra (2nd Edition, 2025)
    type: book
    year: 2025
    authors:
      - Meyer C.D.
    institution: SIAM
    url: https://my.siam.org/Store/Product/viewproduct/?ProductId=37827
secondary_sources:
  - title: ACM Digital Library
    type: repository
    year: 2026

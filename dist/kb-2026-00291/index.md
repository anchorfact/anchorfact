...
atomic_facts:
  ...
  - id: "fact-computer-science-001"
    statement: "Spring Boot (Pivotal/VMware, 2014) simplifies Java enterprise development with auto-configuration, embedded servers (Tomcat, Jetty), and starter dependencies. Built on the Spring Framework (2002), it is the dominant Java backend framework. Spring Boot 3.x requires Java 17+ and Jakarta EE."
    source_title: "Spring Boot Documentation"
    source_url: "https://docs.spring.io/spring-boot/"
    confidence: "medium"

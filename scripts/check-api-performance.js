...
export const DEFAULT_ARTIFACT_SIZE_BUDGETS = [
  { path: 'graph.json', baseline_bytes: 2997236, max_bytes: 4650000, purpose: 'offline relationship graph' },
  { path: 'search-index.json', baseline_bytes: 1986169, max_bytes: 3050000, purpose: 'offline search fallback' },
  { path: 'claims.json', baseline_bytes: 1738706, max_bytes: 2650000, purpose: 'offline claim corpus' },
  { path: 'sources.json', baseline_bytes: 1175562, max_bytes: 1800000, purpose: 'offline source corpus' },

...
const STALE_METRIC_PATTERNS = [
  /1347 public/i,
  /1347 public entries/i,
  /Public eligible articles\s*\|\s*1347/i,
  /Public articles\s*\|\s*1347/i,
  /EXPECTED_PUBLIC_ARTICLES=1347/i,
  /281 draft/i,
  /EXPECTED_DRAFT_ARTICLES=281/i,
  /4299 claims/i,
  /4299 public claims/i,
  /4299 published claims/i,
  /4299 claims from production smoke/i,
  /Public claims\s*\|\s*4299/i,
  /EXPECTED_CLAIMS=4299/i,
  /3278 public sources/i,
  /1346 public/i,
  /1346 public entries/i,
  /Public eligible articles\s*\|\s*1346/i,
  /Public articles\s*\|\s*1346/i,
  /EXPECTED_PUBLIC_ARTICLES=1346/i,
  /282 draft/i,
  /EXPECTED_DRAFT_ARTICLES=282/i,
  /4293 claims/i,
  /4293 public claims/i,
  /4293 published claims/i,
  /4293 claims from production smoke/i,
  /Public claims\s*\|\s*4293/i,
  /EXPECTED_CLAIMS=4293/i,
  /3274 public sources/i,
  /1345 public/i,
  /1345 public entries/i,
  /Public eligible articles\s*\|\s*1345/i,
  /Public articles\s*\|\s*1345/i,
  /EXPECTED_PUBLIC_ARTICLES=1345/i,
  /283 draft/i,
  /EXPECTED_DRAFT_ARTICLES=283/i,
  /4288 claims/i,
  /4288 public claims/i,
  /4288 published claims/i,
  /4288 claims from production smoke/i,
  /Public claims\s*\|\s*4288/i,
  /EXPECTED_CLAIMS=4288/i,
  /3269 public sources/i,
  /1344 public/i,
  /1344 public entries/i,
  /Public eligible articles\s*\|\s*1344/i,
  /Public articles\s*\|\s*1344/i,
  /EXPECTED_PUBLIC_ARTICLES=1344/i,
  /284 draft/i,
  /EXPECTED_DRAFT_ARTICLES=284/i,
  /4282 claims/i,
  /4282 public claims/i,
  /4282 published claims/i,
  /4282 claims from production smoke/i,
  /Public claims\s*\|\s*4282/i,
  /EXPECTED_CLAIMS=4282/i,
  /1343 public/i,
  /1343 public entries/i,
  /Public eligible articles\s*\|\s*1343/i,
  /Public articles\s*\|\s*1343/i,
  /EXPECTED_PUBLIC_ARTICLES=1343/i,
  /285 draft/i,
  /EXPECTED_DRAFT_ARTICLES=285/i,
  /4277 claims/i,
  /4277 public claims/i,
  /4277 published claims/i,
  /4277 claims from production smoke/i,
  /Public claims\s*\|\s*4277/i,
  /EXPECTED_CLAIMS=4277/i,
  /3265 public sources/i,
  /1329 public/i,
  /1329 public entries/i,
  /Public eligible articles\s*\|\s*1329/i,
  /Public articles\s*\|\s*1329/i,
  /EXPECTED_PUBLIC_ARTICLES=1329/i,
  /299 draft/i,
  /EXPECTED_DRAFT_ARTICLES=299/i,
  /4226 claims/i,
  /4226 public claims/i,
  /4226 published claims/i,
  /4226 claims from production smoke/i,
  /Public claims\s*\|\s*4226/i,
  /EXPECTED_CLAIMS=4226/i,
  /3221 public sources/i,
  /1328 public/i,
  /1328 public entries/i,
  /Public eligible articles\s*\|\s*1328/i,
  /Public articles\s*\|\s*1328/i,
  /EXPECTED_PUBLIC_ARTICLES=1328/i,
  /4224 claims/i,
  /4224 public claims/i,
  /4224 published claims/i,
  /4224 claims from production smoke/i,
  /Public claims\s*\|\s*4224/i,
  /EXPECTED_CLAIMS=4224/i,
  /3220 public sources/i,
  /1621 articles/i,
  /1321 public/i,
  /1321 public entries/i,
  /Public eligible articles\s*\|\s*1321/i,
  /Public articles\s*\|\s*1321/i,
  /EXPECTED_PUBLIC_ARTICLES=1321/i,
  /4189 claims/i,
  /4189 public claims/i,
  /4189 published claims/i,
  /4189 claims from production smoke/i,
  /Public claims\s*\|\s*4189/i,
  /EXPECTED_CLAIMS=4189/i,
  /3208 public sources/i,
  /1614 articles/i,
  /1314 public/i,
  /1314 public entries/i,
  /Public eligible articles\s*\|\s*1314/i,
  /Public articles\s*\|\s*1314/i,
  /EXPECTED_PUBLIC_ARTICLES=1314/i,
  /4154 claims/i,
  /4154 public claims/i,
  /4154 published claims/i,
  /4154 claims from production smoke/i,
  /Public claims\s*\|\s*4154/i,
  /EXPECTED_CLAIMS=4154/i,
  /3193 public sources/i,
  /1608 articles/i,
  /1308 public/i,
  /1308 public entries/i,
  /Public eligible articles\s*\|\s*1308/i,
  /Public articles\s*\|\s*1308/i,
  /EXPECTED_PUBLIC_ARTICLES=1308/i,
  /4124 claims/i,
  /4124 public claims/i,
  /4124 published claims/i,
  /4124 claims from production smoke/i,
  /Public claims\s*\|\s*4124/i,
  /EXPECTED_CLAIMS=4124/i,
  /3185 public sources/i,
  /1602 articles/i,
  /1302 public/i,
  /1302 public entries/i,
  /Public eligible articles\s*\|\s*1302/i,
  /Public articles\s*\|\s*1302/i,
  /EXPECTED_PUBLIC_ARTICLES=1302/i,
  /4094 claims/i,
  /4094 public claims/i,
  /4094 published claims/i,
  /4094 claims from production smoke/i,
  /Public claims\s*\|\s*4094/i,
  /EXPECTED_CLAIMS=4094/i,
  /3177 public sources/i,
  /1597 articles/i,
  /1297 public/i,
  /1297 public entries/i,
  /Public eligible articles\s*\|\s*1297/i,
  /Public articles\s*\|\s*1297/i,
  /EXPECTED_PUBLIC_ARTICLES=1297/i,
  /4069 claims/i,
  /4069 public claims/i,
  /4069 published claims/i,
  /4069 claims from production smoke/i,
  /Public claims\s*\|\s*4069/i,
  /EXPECTED_CLAIMS=4069/i,
  /3168 public sources/i,
  /4068 claims/i,
  /4068 public claims/i,
  /4068 published claims/i,
  /4068 claims from production smoke/i,
  /Public claims\s*\|\s*4068/i,
  /EXPECTED_CLAIMS=4068/i,
  /3167 public sources/i,
  /1592 articles/i,
  /1292 public/i,
  /1292 public entries/i,
  /Public eligible articles\s*\|\s*1292/i,
  /Public articles\s*\|\s*1292/i,
  /EXPECTED_PUBLIC_ARTICLES=1292/i,
  /4048 claims/i,
  /4048 public claims/i,
  /4048 published claims/i,
  /4048 claims from production smoke/i,
  /Public claims\s*\|\s*4048/i,
  /EXPECTED_CLAIMS=4048/i,
  /3159 public sources/i,
  /1588 articles/i,
  /1288 public/i,
  /1288 public entries/i,
  /Public eligible articles\s*\|\s*1288/i,
  /Public articles\s*\|\s*1288/i,
  /EXPECTED_PUBLIC_ARTICLES=1288/i,
  /4033 claims/i,
  /4033 public claims/i,
  /4033 published claims/i,
  /4033 claims from production smoke/i,
  /Public claims\s*\|\s*4033/i,
  /EXPECTED_CLAIMS=4033/i,
  /3151 public sources/i,
  /1584 articles/i,
  /1284 public/i,
  /1284 public entries/i,
  /Public eligible articles\s*\|\s*1284/i,
  /Public articles\s*\|\s*1284/i,
  /EXPECTED_PUBLIC_ARTICLES=1284/i,
  /4021 claims/i,
  /4021 public claims/i,
  /4021 published claims/i,
  /4021 claims from production smoke/i,
  /Public claims\s*\|\s*4021/i,
  /EXPECTED_CLAIMS=4021/i,
  /3143 public sources/i,
  /1581 articles/i,
  /1281 public/i,
  /1281 public entries/i,
  /Public eligible articles\s*\|\s*1281/i,
  /Public articles\s*\|\s*1281/i,
  /EXPECTED_PUBLIC_ARTICLES=1281/i,
  /4012 claims/i,
  /4012 public claims/i,
  /4012 published claims/i,
  /4012 claims from production smoke/i,
  /Public claims\s*\|\s*4012/i,
  /EXPECTED_CLAIMS=4012/i,
  /3142 public sources/i,
  /3137 public sources/i,
  /1578 articles/i,
  /1278 public/i,
  /1278 public entries/i,
  /Public eligible articles\s*\|\s*1278/i,
  /Public articles\s*\|\s*1278/i,
  /EXPECTED_PUBLIC_ARTICLES=1278/i,
  /4003 claims/i,
  /4003 public claims/i,
  /4003 published claims/i,
  /4003 claims from production smoke/i,
  /Public claims\s*\|\s*4003/i,
  /EXPECTED_CLAIMS=4003/i,
  /3130 public sources/i,
  /1565 articles/i,
  /1265 public/i,
  /1265 public entries/i,
  /Public eligible articles\s*\|\s*1265/i,
  /Public articles\s*\|\s*1265/i,
  /EXPECTED_PUBLIC_ARTICLES=1265/i,
  /3955 claims/i,
  /3955 public claims/i,
  /3955 published claims/i,
  /3955 claims from production smoke/i,
  /Public claims\s*\|\s*3955/i,
  /EXPECTED_CLAIMS=3955/i,
  /3105 public sources/i,
  /1561 articles/i,
  /1261 public/i,
  /1261 public entries/i,
  /Public eligible articles\s*\|\s*1261/i,
  /Public articles\s*\|\s*1261/i,
  /EXPECTED_PUBLIC_ARTICLES=1261/i,
  /3943 claims/i,
  /3943 public claims/i,
  /3943 published claims/i,
  /3943 claims from production smoke/i,
  /Public claims\s*\|\s*3943/i,
  /EXPECTED_CLAIMS=3943/i,
  /3098 public sources/i,
  /1557 articles/i,
  /1257 public/i,
  /1257 public entries/i,
  /Public eligible articles\s*\|\s*1257/i,
  /Public articles\s*\|\s*1257/i,
  /EXPECTED_PUBLIC_ARTICLES=1257/i,
  /3931 claims/i,
  /3931 public claims/i,
  /3931 published claims/i,
  /3931 claims from production smoke/i,
  /Public claims\s*\|\s*3931/i,
  /EXPECTED_CLAIMS=3931/i,
  /3089 public sources/i,
  /1553 articles/i,
  /1253 public/i,
  /1253 public entries/i,
  /Public eligible articles\s*\|\s*1253/i,
  /Public articles\s*\|\s*1253/i,
  /EXPECTED_PUBLIC_ARTICLES=1253/i,
  /3919 claims/i,
  /3919 public claims/i,
  /3919 published claims/i,
  /3919 claims from production smoke/i,
  /Public claims\s*\|\s*3919/i,
  /EXPECTED_CLAIMS=3919/i,
  /3081 public sources/i,
  /1549 articles/i,
  /1249 public/i,
  /1249 public entries/i,
  /Public eligible articles\s*\|\s*1249/i,
  /Public articles\s*\|\s*1249/i,
  /EXPECTED_PUBLIC_ARTICLES=1249/i,
  /3907 claims/i,
  /3907 public claims/i,
  /3907 published claims/i,
  /3907 claims from production smoke/i,
  /Public claims\s*\|\s*3907/i,
  /EXPECTED_CLAIMS=3907/i,
  /3071 public sources/i,
  /1543 articles/i,
  /1243 public/i,
  /1243 public entries/i,
  /Public eligible articles\s*\|\s*1243/i,
  /Public articles\s*\|\s*1243/i,
  /EXPECTED_PUBLIC_ARTICLES=1243/i,
  /3889 claims/i,
  /3889 public claims/i,
  /3889 published claims/i,
  /3889 claims from production smoke/i,
  /Public claims\s*\|\s*3889/i,
  /EXPECTED_CLAIMS=3889/i,
  /3062 public sources/i,
  /1535 articles/i,
  /1235 public/i,
  /1235 public entries/i,
  /Public eligible articles\s*\|\s*1235/i,
  /Public articles\s*\|\s*1235/i,
  /EXPECTED_PUBLIC_ARTICLES=1235/i,
  /3865 claims/i,
  /3865 public claims/i,
  /3865 published claims/i,
  /3865 claims from production smoke/i,
  /Public claims\s*\|\s*3865/i,
  /EXPECTED_CLAIMS=3865/i,
  /3040 public sources/i,
  /1529 articles/i,
  /1229 public/i,
  /1229 public entries/i,
  /Public eligible articles\s*\|\s*1229/i,
  /Public articles\s*\|\s*1229/i,
  /EXPECTED_PUBLIC_ARTICLES=1229/i,
  /3847 claims/i,
  /3847 public claims/i,
  /3847 published claims/i,
  /3847 claims from production smoke/i,
  /Public claims\s*\|\s*3847/i,
  /EXPECTED_CLAIMS=3847/i,
  /3029 public sources/i,
  /1523 articles/i,
  /1223 public/i,
  /1223 public entries/i,
  /Public eligible articles\s*\|\s*1223/i,
  /Public articles\s*\|\s*1223/i,
  /EXPECTED_PUBLIC_ARTICLES=1223/i,
  /3829 claims/i,
  /3829 public claims/i,
  /3829 published claims/i,
  /3829 claims from production smoke/i,
  /Public claims\s*\|\s*3829/i,
  /EXPECTED_CLAIMS=3829/i,
  /3018 public sources/i,
  /1517 articles/i,
  /1217 public/i,
  /1217 public entries/i,
  /Public eligible articles\s*\|\s*1217/i,
  /Public articles\s*\|\s*1217/i,
  /EXPECTED_PUBLIC_ARTICLES=1217/i,
  /3811 claims/i,
  /3811 public claims/i,
  /3811 published claims/i,
  /3811 claims from production smoke/i,
  /Public claims\s*\|\s*3811/i,
  /EXPECTED_CLAIMS=3811/i,
  /3009 public sources/i,
  /1510 articles/i,
  /1210 public/i,
  /1210 public entries/i,
  /Public eligible articles\s*\|\s*1210/i,
  /Public articles\s*\|\s*1210/i,
  /EXPECTED_PUBLIC_ARTICLES=1210/i,
  /3790 claims/i,
  /3790 public claims/i,
  /3790 published claims/i,
  /3790 claims from production smoke/i,
  /Public claims\s*\|\s*3790/i,
  /EXPECTED_CLAIMS=3790/i,
  /1502 articles/i,
  /1202 public/i,
  /1202 public entries/i,
  /Public eligible articles\s*\|\s*1202/i,
  /Public articles\s*\|\s*1202/i,
  /EXPECTED_PUBLIC_ARTICLES=1202/i,
  /3766 claims/i,
  /3766 public claims/i,
  /3766 published claims/i,
  /3766 claims from production smoke/i,
  /Public claims\s*\|\s*3766/i,
  /EXPECTED_CLAIMS=3766/i,
  /2978 public sources/i,
  /1494 articles/i,
  /1194 public/i,
  /1194 public entries/i,
  /Public eligible articles\s*\|\s*1194/i,
  /Public articles\s*\|\s*1194/i,
  /EXPECTED_PUBLIC_ARTICLES=1194/i,
  /3742 claims/i,
  /3742 public claims/i,
  /3742 published claims/i,
  /3742 claims from production smoke/i,
  /Public claims\s*\|\s*3742/i,
  /EXPECTED_CLAIMS=3742/i,
  /2967 public sources/i,
  /1484 articles/i,
  /1184 public/i,
  /1184 public entries/i,
  /Public eligible articles\s*\|\s*1184/i,
  /Public articles\s*\|\s*1184/i,
  /EXPECTED_PUBLIC_ARTICLES=1184/i,
  /3708 claims/i,
  /3708 public claims/i,
  /3708 published claims/i,
  /3708 claims from production smoke/i,
  /Public claims\s*\|\s*3708/i,
  /EXPECTED_CLAIMS=3708/i,
  /2950 public sources/i,
  /1474 articles/i,
  /1174 public/i,

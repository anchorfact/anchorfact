...
test('buildEvalsIndex produces executable AI integration checks', () => {
  ...
  assertEq(healthEval.expected.repair_queue_source_ready_fields, true);
  assertEq(healthEval.expected.repair_queue_source_acquisition_fields, true);
  assertEq(healthEval.expected.repair_queue_policy_contains, ['AI-agent utility', 'repair_complexity', 'source-ready', 'source acquisition']);

...
> AnchorFact: 1484 articles, 1184 public entries, 3708 public claims, and a public trust model for machine-readable citations.
...
The verification step is incremental. It checks file modification times and only re-verifies changed articles. The current verification snapshot covers 1484 articles and averages 2.6 sources per article. Incremental verification remains fast for unchanged files.

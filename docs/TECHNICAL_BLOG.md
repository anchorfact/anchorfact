...
> AnchorFact: 1523 articles, 1223 public entries, 3829 public claims, and a public trust model for machine-readable citations.
...
The verification step is incremental. It checks file modification times and only re-verifies changed articles. The current verification snapshot covers 1523 articles and averages 2.6 sources per article. Incremental verification remains fast for unchanged files.

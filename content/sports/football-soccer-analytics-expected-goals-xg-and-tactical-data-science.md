---
id: kb-2026-00014
title: 'Football (Soccer) Analytics: Expected Goals (xG) and Tactical Data Science'
...
disputed_statements: []
primary_sources:
  - title: 'Source 1 — Football (Soccer) Analytics: Expected Goals (xG) and Tactical Data Science'
    type: blog_post
    year: 2026
...
[简要概述：Football (Soccer) Analytics: Expected Goals (xG) and Tactical Data Science 是什么，为什么重要，关键事实。待填充。]
...
- [Source 1](https://statsbomb.com/soccer-metrics/)

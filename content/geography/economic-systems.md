...
atomic_facts:
  - id: fact-geography-001
    statement: >-
      Economic systems organize production, distribution, and consumption. Types: capitalism (private ownership, market-driven), socialism (public/state ownership, planned), mixed economy (most
      countries — blend of both). Key indicators: GDP (total output), inflation, unemployment, Gini coefficient (inequality).
    confidence: medium

...
atomic_facts:
  ...
  - id: "fact-game-development-003"
    statement: "Key mechanics: procedural level generation (seeded random, room templates, cellular automata), permadeath (+ meta-progression for roguelites), emergent gameplay (systems interact unexpectedly), replayability via randomization."
    source_url: "https://www.gdconf.com/"
    confidence: "medium"

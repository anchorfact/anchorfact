...
atomic_facts:
  ...
  - id: "fact-gd-002"
    ...
    confidence: "medium"
  - id: "fact-gd-003"
    statement: "DoubleTap),                 new GamepadButtonBinding(GamepadButton."
    source_title: "游戏开发Wiki（个人知识库）"
    source_url: "https://www.gdconf.com/"
    confidence: "medium"
  - id: "fact-gd-004"
...
public class AimAssistSystem
{
    ...
    public Vector3 ApplyAimAssist(Vector3 rawAimInput, Vector3 playerPos, List<Target> enemies)
    {
        // 1. 寻找准星附近的有效目标

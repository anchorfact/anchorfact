...
atomic_facts:
  ...
  - id: fact-ai-002
    ...
    source_url: https://szeliski.org/Book/
  - id: fact-ai-003
    statement: "Vision Transformer (ViT, 2020): apply Transformer to image patches — competitive with CNNs."
    confidence: medium
    source_title: "Computer Vision: Algorithms and Applications (2nd Edition)"
    source_url: https://szeliski.org/Book/
  - id: fact-ai-004
    statement: "Multimodal: CLIP (OpenAI 2021) learns joint image-text embeddings."
    confidence: medium
    source_title: "Computer Vision: Algorithms and Applications (2nd Edition)"
    source_url: https://szeliski.org/Book/
completeness: 0.88

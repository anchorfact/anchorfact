...
atomic_facts:
  ...
  - id: "af-ai-for-regtech-compliance-2"
    statement: "Regulatory intelligence AI -- NLP models that continuously monitor, ingest, and analyze regulatory changes across jurisdictions (SEC, FCA, ESMA, MAS, etc.) -- enables financial institutions to automate compliance gap analysis, policy updates, and regulatory reporting. Large language models (GPT-4, Claude) are being deployed to summarize regulatory documents, extract obligations, map requirements to internal controls, and generate compliance reports, reducing compliance analyst workload by 30-50% according to industry estimates."

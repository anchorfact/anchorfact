...
atomic_facts:
  - id: "af-ai-for-weather-forecasting-1"
    statement: "Google DeepMind's GraphCast (Science, November 2023) demonstrated that a graph neural network trained on 39 years of ERA5 reanalysis data can produce 10-day global weather forecasts in under 1 minute on a single TPU -- matching or exceeding the ECMWF Integrated Forecasting System (IFS) on 90% of 1,380 verification targets, while being 1,000x computationally cheaper. This represents a paradigm shift from physics-based numerical weather prediction (NWP) to data-driven forecasting."

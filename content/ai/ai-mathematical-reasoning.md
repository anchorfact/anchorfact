...
atomic_facts:
  ...
  - id: "af-ai-mathematical-reasoning-2"
    statement: "AlphaGeometry (Trinh et al., Nature 2024) solved 25/30 IMO geometry problems by combining a neural language model with a symbolic deduction engine (Deductive Database), approaching IMO gold medalist level (average 25.9), and trained on 100M synthetic geometry theorems without human demonstrations."

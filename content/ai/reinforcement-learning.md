...
atomic_facts:
  ...
  - id: fact-ai-001
    ...
    confidence: high
    source_title: Human-level control through deep reinforcement learning (DQN)
    source_url: https://www.nature.com/articles/nature14236
    source_doi: 10.1038/nature14236
  - id: fact-ai-002
    statement: "Markov Decision Process (MDP): formalizes RL as (S, A, P, R, γ)."
    confidence: medium
    source_title: "Reinforcement Learning: An Introduction (2nd Edition)"
    source_url: http://incompleteideas.net/book/the-book-2nd.html
  - id: fact-ai-003
    statement: "Deep Q-Network (DQN, DeepMind 2013): combines Q-learning with deep neural networks, mastered Atari games from pixels."
    confidence: high
    source_title: Human-level control through deep reinforcement learning (DQN)
    source_url: https://www.nature.com/articles/nature14236
    source_doi: 10.1038/nature14236

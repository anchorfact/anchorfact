...
atomic_facts:
  ...
  - id: fact-health-001
    statement: >-
      Public health focuses on preventing disease and promoting health at population level — in contrast to clinical medicine's individual focus. Core functions: assessment (monitor health), policy
      development, assurance (ensure access). Key achievements: vaccination, sanitation, tobacco control, motor vehicle safety, infectious disease control.
    confidence: medium
    source_title: Introduction to Public Health (Schneider, 6th Ed)
    source_url: https://www.jblearning.com/catalog/productdetails/9781284197594
  - id: fact-health-002

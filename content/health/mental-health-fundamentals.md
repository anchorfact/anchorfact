...
atomic_facts:
  ...
  - id: "af-mental-health-fundamentals-2"
    statement: "SSRIs — including fluoxetine (Prozac), sertraline (Zoloft), and escitalopram (Lexapro) — are first-line treatments for depression, acting by blocking serotonin transporter (SERT) reuptake to increase synaptic serotonin availability."

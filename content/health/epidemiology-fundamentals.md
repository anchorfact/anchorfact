...
atomic_facts:
  - id: "af-epidemiology-fundamentals-1"
    statement: "John Snow's 1854 cholera investigation in London — mapping cases to the contaminated Broad Street pump — is considered the founding event of modern epidemiology."
    source_title: "CDC Principles of Epidemiology"
    confidence: "high"
  - id: "af-epidemiology-fundamentals-2"
    statement: "The basic reproduction number (R0) represents average secondary infections from one case. COVID-19 ancestral strain had R0 2.5-3.0; measles has R0 12-18 — the most contagious known virus."
    source_title: "WHO Epidemiology Handbook"
    confidence: "high"

...
atomic_facts:
  - id: "af-decision-making-psychology-1"
    statement: "Daniel Kahneman and Amos Tversky's prospect theory (1979) demonstrated loss aversion — losses feel ~2x more painful than equivalent gains feel pleasurable — one of the most replicated findings in behavioral economics."
    source_title: "Science (1979)"
    confidence: "high"
  - id: "af-decision-making-psychology-2"
    statement: "The dual-process theory distinguishes System 1 (fast, automatic, intuitive) from System 2 (slow, deliberate, analytical). System 1 makes ~95% of daily decisions, using efficient but systematically biased heuristics."

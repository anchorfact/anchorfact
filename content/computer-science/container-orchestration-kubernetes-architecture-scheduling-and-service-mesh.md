...
disputed_statements: []
primary_sources:
  - title: 'Source 1 — Container Orchestration: Kubernetes Architecture, Scheduling, and Service Mesh'
    type: blog_post
    year: 2026
...
[简要概述：Container Orchestration: Kubernetes Architecture, Scheduling, and Service Mesh 是什么，为什么重要，关键事实。待填充。]
...
- [Source 1](https://kubernetes.io/docs/concepts/)

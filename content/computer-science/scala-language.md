...
atomic_facts:
  - id: fact-computer-science-001
    statement: >-
      Scala (Martin Odersky, 2004, EPFL) elegantly combines object-oriented and functional programming on the JVM. Scala 3 (2021) redesigned with optional braces (Python-like), enums, extension
      methods, and given/using for implicits. Used by: Twitter (originally), Netflix, LinkedIn, Apache Spark.
    confidence: medium

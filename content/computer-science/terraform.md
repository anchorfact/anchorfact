...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      Terraform by HashiCorp is the dominant Infrastructure as Code tool, using HCL (HashiCorp Configuration Language) to declaratively define and provision cloud resources across 3000+ providers.
      State file tracks real-world resources; plan shows pending changes.
    confidence: medium
    source_title: Terraform Documentation
    source_url: https://developer.hashicorp.com/terraform/docs

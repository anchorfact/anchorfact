...
disputed_statements: []
primary_sources:
  - title: 'Source 1 — OpenGL and Vulkan: Graphics Pipeline, Shaders, and GPU Architecture'
    type: blog_post
    year: 2026
...
[简要概述：OpenGL and Vulkan: Graphics Pipeline, Shaders, and GPU Architecture 是什么，为什么重要，关键事实。待填充。]
...
- [Source 1](https://www.khronos.org/vulkan/)

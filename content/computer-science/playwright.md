...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      Playwright is a cross-browser automation library by Microsoft enabling reliable end-to-end testing across Chromium, Firefox, and WebKit with a single API. Unlike Cypress, Playwright runs outside
      the browser as a Node.js process, supporting multiple tabs, iframes, and native mobile emulation.
    confidence: medium
    source_title: Playwright Documentation
    source_url: https://playwright.dev/
  ...
  - id: fact-computer-science-003
    statement: Supports JavaScript, TypeScript, Python, .NET, Java.
    confidence: medium
    source_title: Testing JavaScript Applications
    source_url: https://www.manning.com/books/testing-javascript-applications

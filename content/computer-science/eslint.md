...
atomic_facts:
  ...
  - id: "fact-computer-science-001"
    statement: "ESLint is a static analysis tool for JavaScript/TypeScript that identifies problematic patterns and enforces coding standards. Created by Nicholas Zakas (2013), it is the most popular JS linter. ESLint 9 (2024) introduced flat config (`eslint.config.mjs`), replacing `.eslintrc`."
    source_title: "ESLint Documentation"
    source_url: "https://eslint.org/docs/"
    confidence: "medium"

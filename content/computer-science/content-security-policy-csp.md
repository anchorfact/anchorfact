...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      Content Security Policy (CSP) is a security standard that helps prevent XSS, clickjacking, and code injection attacks by controlling which resources a web page is allowed to load. It is
      delivered via HTTP headers (`Content-Security-Policy`) or `<meta>` tags.
    confidence: medium
    source_title: Content Security Policy Level 2 (W3C Recommendation)
    source_url: https://www.w3.org/TR/CSP2/

...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      Jenkins (Kohsuke Kawaguchi, 2011, forked from Hudson) is the most established open-source CI/CD automation server. Jenkins Pipeline (Jenkinsfile, Groovy DSL) defines build/deploy as code. Over
      1800 plugins. Jenkins is Java-based, highly extensible but complex to maintain.
    confidence: medium
    source_title: Jenkins Documentation
    source_url: https://www.jenkins.io/doc/

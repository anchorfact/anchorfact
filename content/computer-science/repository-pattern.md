...
atomic_facts:
  - id: fact-computer-science-001
    statement: >-
      The Repository pattern mediates between the domain and data mapping layers, acting like an in-memory collection of domain objects. It abstracts data access, enabling swapping data sources
      (database, API, in-memory) without changing business logic.
...
primary_sources:
  - title: ACM Digital Library
    ...
    institution: ACM
  - title: Patterns of Enterprise Application Architecture (2025 Edition)
    type: book
    year: 2025
    authors:
      - Fowler M.
  ...
  - title: "Domain-Driven Design: Tackling Complexity (2025 Anniversary Edition)"
    type: book
    year: 2025
    authors:
      - Evans E.
    institution: Addison-Wesley
    url: https://www.informit.com/ddd/
secondary_sources:
  - title: ACM Digital Library
    type: repository
    year: 2026

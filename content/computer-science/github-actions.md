...
atomic_facts:
  - id: "fact-computer-science-001"
    statement: "GitHub Actions is a CI/CD platform integrated into GitHub repositories. Workflows (YAML files in `.github/workflows/`) trigger on events (push, PR, schedule) and execute jobs on runners (Ubuntu, Windows, macOS). Free for public repositories."
    source_title: "GitHub Actions Documentation"
    source_url: "https://docs.github.com/en/actions"
    confidence: "medium"
  - id: "fact-computer-science-002"
    statement: "Workflow syntax: `on:` defines triggers, `jobs:` defines steps."
    source_title: "GitHub Actions Documentation"
    source_url: "https://docs.github.com/en/actions"
    confidence: "medium"
  - id: "fact-computer-science-003"
    statement: "Runners: GitHub-hosted (2-core, 7GB RAM, free for public) or self-hosted."
    source_title: "GitHub Actions Documentation"
    source_url: "https://docs.github.com/en/actions"
    confidence: "medium"

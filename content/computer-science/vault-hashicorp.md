...
atomic_facts:
  - id: "fact-computer-science-001"
    statement: "HashiCorp Vault (2015) is a secrets management tool — securely stores and controls access to tokens, passwords, certificates, and API keys. Secrets are encrypted at rest and in transit. Dynamic secrets (on-demand, short-lived) eliminate credential sprawl. Enterprise-grade access control via policies."
    source_title: "Vault Documentation"
    source_url: "https://developer.hashicorp.com/vault/docs"
    confidence: "medium"
  - id: "fact-computer-science-002"
    statement: "Secret engines: KV (key-value), AWS (dynamic IAM credentials), PKI (X.509 certificates), database (dynamic DB credentials)."
    source_title: "Vault Documentation"
    source_url: "https://developer.hashicorp.com/vault/docs"
    confidence: "medium"
  - id: "fact-computer-science-003"
    statement: "Seal/unseal: Shamir's Secret Sharing for master key."
    source_title: "Vault Documentation"
    source_url: "https://developer.hashicorp.com/vault/docs"
    confidence: "medium"

...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      MutationObserver is an API that asynchronously monitors DOM changes — additions, removals, attribute changes, and text content modifications. It replaces the deprecated DOM Mutation Events with
      a batched, more performant observer pattern.
    confidence: medium
    source_title: DOM Standard — MutationObserver
    source_url: https://dom.spec.whatwg.org/#interface-mutationobserver

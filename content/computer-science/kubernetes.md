...
atomic_facts:
  - id: fact-computer-science-01
    statement: >-
      Kubernetes is an open-source container orchestration platform originally designed by Google, based on their internal
      Borg system
  ...
  - id: fact-computer-science-02
    statement: >-
      Donated to the CNCF in 2015, it automates deployment, scaling, and management of containerized applications across

...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      Rails (David Heinemeier Hansson, 2004) is a convention-over-configuration web framework in Ruby. It popularized MVC in web development, RESTful routing, database migrations, and scaffolding.
      Rails 7 (2021) introduced Hotwire (Turbo + Stimulus) for reactive UIs without heavy JavaScript.
    confidence: medium
    source_title: Ruby on Rails Guides
    source_url: https://guides.rubyonrails.org/

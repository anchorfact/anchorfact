...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      MQTT is a lightweight publish-subscribe messaging protocol designed for constrained devices and low-bandwidth networks. Created by IBM (1999), standardized by OASIS. Used extensively in IoT:
      smart homes, industrial sensors, connected vehicles. QoS levels: 0 (at most once), 1 (at least once), 2 (exactly once).
    confidence: medium
    source_title: ACM Digital Library
    source_url: https://dl.acm.org/

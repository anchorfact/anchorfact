...
atomic_facts:
  ...
  - id: fact-computer-science-001
    statement: >-
      Nginx is a high-performance web server, reverse proxy, and load balancer created by Igor Sysoev (2004) to solve the C10k problem (10,000 concurrent connections). Its event-driven, asynchronous
      architecture handles massive concurrency with minimal memory.
    confidence: medium
    source_title: NGINX Documentation
    source_url: https://nginx.org/en/docs/

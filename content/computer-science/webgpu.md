...
atomic_facts:
  ...
  - id: "fact-computer-science-001"
    statement: "WebGPU is the next-generation graphics and compute API for the web, succeeding WebGL. Based on modern GPU APIs (Vulkan, Metal, Direct3D 12), it provides lower-level access for better performance, compute shaders, and explicit resource management."
    source_title: "WebGPU (W3C Working Draft)"
    source_url: "https://www.w3.org/TR/webgpu/"
    confidence: "medium"
  - id: "fact-computer-science-002"
    statement: "It introduces: compute shaders (GPU parallel computation beyond graphics), bind groups (explicit resource binding), render bundles (pre-recorded command lists), and WGSL shading language (replacing GLSL)."
    source_title: "WebGPU (W3C Working Draft)"
    source_url: "https://www.w3.org/TR/webgpu/"
    confidence: "medium"

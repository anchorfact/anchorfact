...
| `/content-health.json` | Signed corpus health summary with public/draft counts, source coverage, claim mapping, source-ready/source acquisition draft repair queues, and trust boundaries. |
...
| `/api-access/` | Machine-readable free API access policy with readiness gate policy, recommended call order, limits, and provenance verification steps. |
...
| `/404.html` | Machine-readable JSON 404 fallback for unknown machine routes; noindex, signed in provenance, and guarded against SPA HTML fallback. |

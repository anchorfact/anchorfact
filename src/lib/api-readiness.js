...
export const CORE_CORPUS_QUERIES = [
  ...
  ['agent_execution_sources', 'ai/agent-cloudwatch-logs-insights-and-log-groups', 'Agent CloudWatch Logs Insights and Log Groups'],
  ...
  ['agent_execution_sources', 'ai/agent-docker-build-cache-and-layer-invalidation', 'Agent Docker Build Cache and Layer Invalidation'],
  ['agent_execution_sources', 'ai/agent-container-security-context-seccomp-and-capabilities', 'Agent Container Security Context, Seccomp, and Capabilities'],
  ...
  ['agent_execution_sources', 'ai/agent-terraform-plan-output-and-resource-addresses', 'Agent Terraform Plan Output and Resource Addresses'],
  ...
  ['agent_execution_sources', 'ai/agent-kubernetes-horizontal-pod-autoscaler-and-scale-events', 'Agent Kubernetes Horizontal Pod Autoscaler and Scale Events'],
  ['agent_execution_sources', 'ai/agent-kubernetes-pod-disruption-budgets-and-evictions', 'Agent Kubernetes PodDisruptionBudgets and Evictions'],
  ['agent_execution_sources', 'ai/agent-kubernetes-probes-and-readiness-gates', 'Agent Kubernetes Probes and Readiness Gates'],
  ['agent_execution_sources', 'ai/agent-kubernetes-ephemeral-containers-and-debugging', 'Agent Kubernetes Ephemeral Containers and Debugging'],
  ['agent_execution_sources', 'ai/agent-kubernetes-rbac-and-subjectaccessreviews', 'Agent Kubernetes RBAC and SubjectAccessReviews'],
  ['agent_execution_sources', 'ai/agent-kubernetes-init-containers-and-sidecar-containers', 'Agent Kubernetes Init Containers and Sidecar Containers'],
  ['agent_execution_sources', 'ai/agent-kubernetes-owner-references-and-replicaset-lineage', 'Agent Kubernetes OwnerReferences and ReplicaSet Lineage'],
  ['agent_execution_sources', 'ai/agent-helm-release-history-and-values-overrides', 'Agent Helm Release History and Values Overrides'],
  ['agent_execution_sources', 'ai/agent-github-actions-run-attempts-and-job-summaries', 'Agent GitHub Actions Run Attempts and Job Summaries'],
  ['agent_execution_sources', 'ai/agent-github-actions-environments-and-deployment-review', 'Agent GitHub Actions Environments and Deployment Review'],
  ...
  ['agent_execution_sources', 'ai/agent-prometheus-promql-and-alert-labels', 'Agent Prometheus PromQL and Alert Labels'],
  ...
  ['agent_execution_sources', 'ai/agent-opentelemetry-baggage-and-context-propagation', 'Agent OpenTelemetry Baggage and Context Propagation'],
  ['agent_execution_sources', 'ai/agent-metrics-cardinality-and-label-explosion', 'Agent Metrics Cardinality and Label Explosion'],
  ...
  ['agent_execution_sources', 'ai/agent-cli-help-output-and-man-pages', 'Agent CLI Help Output and Man Pages'],
  ['agent_execution_sources', 'ai/agent-kubernetes-custom-resources-and-finalizers', 'Agent Kubernetes Custom Resources and Finalizers'],
  ['agent_execution_sources', 'ai/agent-redis-slowlog-and-keyspace-notifications', 'Agent Redis Slowlog and Keyspace Notifications'],
  ['agent_execution_sources', 'ai/agent-opentelemetry-tail-sampling-and-trace-retention', 'Agent OpenTelemetry Tail Sampling and Trace Retention'],
  ['agent_execution_sources', 'ai/agent-systemd-journald-and-unit-state', 'Agent systemd Journald and Unit State'],
  ['agent_execution_sources', 'ai/agent-kubernetes-api-resources-and-discovery', 'Agent Kubernetes API Resources and Discovery'],
  ['agent_execution_sources', 'ai/agent-postgresql-pg-stat-activity-and-query-cancellation', 'Agent PostgreSQL pg_stat_activity and Query Cancellation'],
  ['agent_execution_sources', 'ai/agent-linux-disk-space-inodes-and-filesystem-pressure', 'Agent Linux Disk Space Inodes and Filesystem Pressure'],
  ['agent_execution_sources', 'ai/agent-linux-open-files-and-process-inspection', 'Agent Linux Open Files and Process Inspection'],
  ['agent_execution_sources', 'ai/agent-linux-dns-resolution-and-name-service-switch', 'Agent Linux DNS Resolution and Name Service Switch'],
  ['agent_execution_sources', 'ai/agent-linux-cgroups-and-pressure-stall-information', 'Agent Linux Cgroups and Pressure Stall Information'],
  ['agent_execution_sources', 'ai/agent-linux-network-sockets-and-listening-ports', 'Agent Linux Network Sockets and Listening Ports'],
  ['agent_execution_sources', 'ai/agent-linux-routing-tables-and-ip-route-lookup', 'Agent Linux Routing Tables and ip route Lookup'],
  ['agent_execution_sources', 'ai/agent-linux-process-environment-and-procfs-environ', 'Agent Linux Process Environment and procfs environ'],
  ['agent_execution_sources', 'ai/agent-linux-packet-capture-and-tcpdump-filters', 'Agent Linux Packet Capture and tcpdump Filters'],
  ...
  ['agent_rag', 'ai/retrieval-lucene-segments-refresh-and-near-real-time-search', 'Retrieval Lucene Segments, Refresh, and Near Real-Time Search'],
  ...
  ['agent_rag', 'ai/retrieval-score-explanations-and-term-vectors', 'Elasticsearch Explain API term vectors'],
  ['agent_rag', 'ai/retrieval-inverted-index-analyzers-and-token-filters', 'Retrieval Inverted Index Analyzers and Token Filters'],
  ['agent_rag', 'ai/retrieval-field-boosting-and-multi-match-search', 'Retrieval Field Boosting and Multi-Match Search'],
  ...
  ['agent_rag', 'ai/retrieval-hybrid-search-score-weighting-and-alpha', 'Hybrid retrieval alpha weighting vector keyword search'],
  ['agent_rag', 'ai/retrieval-semantic-ranker-captions-and-answers', 'Retrieval Semantic Ranker Captions and Answers'],
  ...
  ['agent_rag', 'ai/retrieval-elasticsearch-point-in-time-and-search-after', 'Retrieval Elasticsearch Point in Time and search_after'],
  ['agent_rag', 'ai/retrieval-federated-search-and-source-routing', 'Retrieval Federated Search and Source Routing'],
  ['agent_rag', 'ai/retrieval-milvus-collections-and-vector-indexes', 'Retrieval Milvus Collections and Vector Indexes'],
  ['agent_rag', 'ai/retrieval-opensearch-neural-search-and-search-pipelines', 'Retrieval OpenSearch Neural Search and Search Pipelines'],
  ['agent_rag', 'ai/retrieval-opensearch-profile-and-explain-debugging', 'Retrieval OpenSearch Profile and Explain Debugging'],
  ['agent_rag', 'ai/retrieval-azure-ai-search-indexers-and-data-sources', 'Retrieval Azure AI Search Indexers and Data Sources'],
  ['agent_rag', 'ai/retrieval-weaviate-collection-schema-and-vectorizer-config', 'Retrieval Weaviate Collection Schema and Vectorizer Config'],
  ['agent_rag', 'ai/retrieval-qdrant-collections-and-payload-indexes', 'Qdrant collections vector filtering indexes'],
  ['agent_rag', 'ai/retrieval-pinecone-indexes-and-namespaces', 'Retrieval Pinecone Indexes and Namespaces'],
  ['agent_rag', 'ai/retrieval-vespa-nearest-neighbor-and-weakand', 'Retrieval Vespa nearestNeighbor and weakAnd'],
  ['agent_rag', 'ai/retrieval-vespa-rank-profiles-and-phased-ranking', 'Retrieval Vespa Rank Profiles and Phased Ranking'],
  ...
  ['agent_rag', 'ai/retrieval-document-versioning-and-source-snapshots', 'Retrieval Document Versioning and Source Snapshots'],
  ...
  ['agent_rag', 'ai/rag-document-content-hashes-and-reindex-triggers', 'RAG Document Content Hashes and Reindex Triggers'],
  ['agent_rag', 'ai/rag-document-layout-and-table-extraction', 'RAG Document Layout and Table Extraction'],
  ['agent_rag', 'ai/vector-store-namespaces-and-tenant-isolation', 'Vector Store Namespaces and Tenant Isolation'],
  ['agent_rag', 'ai/retrieval-chromadb-collections-and-persistent-clients', 'Retrieval ChromaDB Collections and Persistent Clients'],
  ['agent_rag', 'ai/retrieval-pgvector-hnsw-and-ivfflat-indexes', 'Retrieval pgvector HNSW and IVFFlat Indexes'],
  ['agent_rag', 'ai/retrieval-elasticsearch-knn-vector-search-and-filters', 'Retrieval Elasticsearch kNN Vector Search and Filters'],
  ['agent_rag', 'ai/retrieval-redis-vector-search-and-hnsw-indexes', 'Retrieval Redis Vector Search and HNSW Indexes'],
  ...
  ['api_mcp', 'ai/agent-parallel-tool-calls-and-dependency-ordering', 'Agent Parallel Tool Calls and Dependency Ordering'],
  ...
  ['api_mcp', 'ai/agent-output-validation-and-repair-loops', 'Agent Output Validation and Repair Loops'],
  ...
  ['api_mcp', 'computer-science/api-mcp-roots-and-resource-discovery', 'API MCP Roots and Resource Discovery'],
  ['api_mcp', 'computer-science/api-mcp-tools-list-and-call-results', 'API MCP Tools List and Call Results'],
  ['api_mcp', 'computer-science/api-graphql-defer-stream-and-incremental-delivery', 'API GraphQL Defer Stream and Incremental Delivery'],
  ['api_mcp', 'computer-science/api-asyncapi-channels-operations-and-messages', 'API AsyncAPI Channels Operations and Messages'],
  ...
  ['api_mcp', 'computer-science/api-a2a-agent-card-and-skills', 'API A2A Agent Card and Skills'],
  ...
  ['data_infrastructure', 'computer-science/data-kafka-consumer-group-offsets-and-rebalancing', 'Data Kafka Consumer Group Offsets and Rebalancing'],
  ['data_infrastructure', 'computer-science/data-kafka-log-compaction-and-tombstones', 'Data Kafka Log Compaction and Tombstones'],
  ['data_infrastructure', 'computer-science/streaming-watermarks-and-late-data', 'Streaming Watermarks and Late Data'],
  ['data_infrastructure', 'computer-science/data-flink-checkpoints-and-savepoints', 'Data Flink Checkpoints and Savepoints'],
  ['data_infrastructure', 'computer-science/data-airflow-task-instances-and-xcom', 'Data Airflow Task Instances and XCom'],
  ['data_infrastructure', 'computer-science/data-spark-adaptive-query-execution-and-explain-plans', 'Data Spark Adaptive Query Execution and Explain Plans'],
  ...
  ['data_infrastructure', 'computer-science/data-bigquery-job-statistics-and-query-plans', 'Data BigQuery Job Statistics and Query Plans'],
  ['data_infrastructure', 'computer-science/data-bigquery-information-schema-jobs-and-query-history', 'Data BigQuery INFORMATION_SCHEMA Jobs and Query History'],
  ...
  ['data_infrastructure', 'computer-science/data-iceberg-delete-files-and-row-level-deletes', 'Data Iceberg Delete Files and Row-Level Deletes'],
  ['data_infrastructure', 'computer-science/data-iceberg-branches-tags-and-write-audit-publish', 'Data Iceberg Branches Tags and Write-Audit-Publish'],
  ...
  ['data_infrastructure', 'computer-science/data-dbt-exposures-and-downstream-dependencies', 'Data dbt Exposures and Downstream Dependencies'],
  ['data_infrastructure', 'computer-science/data-great-expectations-validation-definitions-and-checkpoints', 'Data Great Expectations Validation Definitions and Checkpoints'],
  ['data_infrastructure', 'computer-science/data-dbt-artifacts-manifest-catalog-and-run-results', 'Data dbt Artifacts Manifest Catalog and Run Results'],
  ['data_infrastructure', 'computer-science/data-schema-registry-subjects-and-compatibility', 'Data Schema Registry Subjects and Compatibility'],
  ['data_infrastructure', 'computer-science/data-databricks-unity-catalog-lineage-and-permissions', 'Data Databricks Unity Catalog Lineage and Permissions'],
  ['data_infrastructure', 'computer-science/data-snowflake-streams-and-tasks-change-processing', 'Data Snowflake Streams and Tasks Change Processing'],
  ['data_infrastructure', 'computer-science/data-duckdb-query-profiling-and-explain-plans', 'Data DuckDB Query Profiling and Explain Plans'],
  ['data_infrastructure', 'computer-science/data-redshift-system-tables-and-query-monitoring', 'Data Redshift System Tables and Query Monitoring'],
  ['data_infrastructure', 'computer-science/data-trino-explain-plans-and-cost-estimates', 'Data Trino EXPLAIN Plans and Cost Estimates'],
  ['data_infrastructure', 'computer-science/data-clickhouse-mergetree-parts-and-mutations', 'Data ClickHouse MergeTree Parts and Mutations'],
  ['data_infrastructure', 'computer-science/data-apache-arrow-columnar-interchange', 'Data Apache Arrow Columnar Interchange'],
  ['data_infrastructure', 'computer-science/data-avro-schema-resolution-and-object-container-files', 'Data Avro Schema Resolution and Object Container Files'],
  ['data_infrastructure', 'computer-science/data-orc-stripes-and-column-statistics', 'Data ORC Stripes and Column Statistics'],
  ['data_infrastructure', 'computer-science/data-parquet-page-indexes-and-bloom-filters', 'Data Parquet Page Indexes and Bloom Filters'],
  ['data_infrastructure', 'computer-science/data-parquet-row-groups-and-statistics', 'Data Parquet Row Groups and Statistics'],
  ['data_infrastructure', 'computer-science/data-lake-file-skipping-and-data-skipping-indexes', 'Data Lake File Skipping and Data Skipping Indexes'],
  ['data_infrastructure', 'computer-science/data-airbyte-connector-state-and-incremental-syncs', 'Data Airbyte Connector State and Incremental Syncs'],
  ['data_infrastructure', 'computer-science/data-snowflake-access-history-and-object-lineage', 'Data Snowflake ACCESS_HISTORY and Object Lineage'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-arena-style-pairwise-ranking', 'LLM Evaluation Arena-Style Pairwise Ranking'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-ifeval-instruction-following-benchmarks', 'LLM Evaluation IFEval Instruction-Following Benchmarks'],
  ['llm_evaluation', 'ai/llm-evaluation-berkeley-function-calling-leaderboard', 'LLM Evaluation Berkeley Function Calling Leaderboard'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-slice-based-regression-analysis', 'LLM Evaluation Slice-Based Regression Analysis'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-helm-scenarios-and-metrics', 'LLM Evaluation HELM Scenarios and Metrics'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-exact-match-fuzzy-match-and-code-graders', 'LLM Evaluation Exact Match, Fuzzy Match, and Code Graders'],
  ['llm_evaluation', 'ai/llm-evaluation-promptfoo-test-cases-and-assertions', 'LLM Evaluation Promptfoo Test Cases and Assertions'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-mteb-embedding-retrieval-benchmarks', 'LLM Evaluation MTEB Embedding and Retrieval Benchmarks'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-osworld-computer-use-benchmarks', 'LLM Evaluation OSWorld Computer-Use Benchmarks'],
  ['llm_evaluation', 'ai/llm-evaluation-webarena-web-agent-benchmarks', 'LLM Evaluation WebArena Web-Agent Benchmarks'],
  ['llm_evaluation', 'ai/llm-evaluation-swe-bench-verified-code-agent-benchmarks', 'LLM Evaluation SWE-bench Verified Code-Agent Benchmarks'],
  ['llm_evaluation', 'ai/llm-evaluation-mle-bench-machine-learning-engineering', 'LLM Evaluation MLE-bench Machine Learning Engineering'],
  ['llm_evaluation', 'ai/llm-evaluation-lm-eval-harness-task-yaml', 'LLM Evaluation lm-eval Harness Task YAML'],
  ['llm_evaluation', 'ai/llm-evaluation-tau-bench-tool-agent-benchmarks', 'LLM Evaluation Tau-bench Tool-Agent Benchmarks'],
  ['llm_evaluation', 'ai/llm-evaluation-gaia-assistant-benchmark', 'LLM Evaluation GAIA Assistant Benchmark'],
  ['llm_evaluation', 'ai/llm-evaluation-terminal-bench-command-line-agent-benchmarks', 'LLM Evaluation Terminal-Bench Command-Line Agent Benchmarks'],
  ['llm_evaluation', 'ai/llm-evaluation-aider-polyglot-code-benchmark', 'LLM Evaluation Aider Polyglot Code Benchmark'],
  ['llm_evaluation', 'ai/llm-evaluation-deepeval-test-cases-and-metrics', 'LLM Evaluation DeepEval Test Cases and Metrics'],
  ...
  ['developer_workflows', 'computer-science/api-oauth-token-revocation-and-refresh-tokens', 'API OAuth Token Revocation and Refresh Tokens'],
  ...
  ['developer_workflows', 'computer-science/api-grpc-status-codes-and-error-details', 'API gRPC Status Codes and Error Details'],
  ['developer_workflows', 'computer-science/api-grpc-deadlines-and-cancellation', 'API gRPC Deadlines and Cancellation'],
  ['developer_workflows', 'computer-science/api-protobuf-field-presence-and-unknown-fields', 'API Protobuf Field Presence and Unknown Fields'],
  ['developer_workflows', 'computer-science/api-protobuf-json-mapping-and-field-names', 'API Protobuf JSON Mapping and Field Names'],
  ...
  ['developer_workflows', 'computer-science/api-websocket-subprotocol-negotiation-for-agents', 'API WebSocket Subprotocol Negotiation for Agents'],
  ...
  ['developer_workflows', 'computer-science/api-prefer-header-return-minimal-and-respond-async', 'API Prefer Header return=minimal and respond-async'],
  ...
  ['developer_workflows', 'computer-science/api-http-message-signatures-and-signature-input', 'API HTTP Message Signatures and Signature-Input'],
  ...
  ['developer_workflows', 'computer-science/api-graphql-query-cost-and-depth-limits', 'GraphQL depth limits query complexity analysis'],
  ['developer_workflows', 'computer-science/api-graphql-federation-and-subgraph-schemas', 'API GraphQL Federation and Subgraph Schemas'],
  ['developer_workflows', 'computer-science/api-json-rpc-request-ids-and-error-objects', 'API JSON-RPC Request IDs and Error Objects'],
  ['developer_workflows', 'computer-science/api-json-schema-dialects-and-vocabularies', 'API JSON Schema Dialects and Vocabularies'],
  ...
  ['developer_workflows', 'computer-science/api-openapi-parameter-serialization-style-and-explode', 'API OpenAPI Parameter Serialization Style and Explode'],
  ['developer_workflows', 'computer-science/api-openapi-arazzo-workflows-and-overlays', 'API OpenAPI Arazzo Workflows and Overlays'],
  ['developer_workflows', 'computer-science/api-openapi-request-body-media-types-and-encoding', 'API OpenAPI Request Body Media Types and Encoding'],
  ['developer_workflows', 'computer-science/api-grpc-health-checking-for-agent-clients', 'API gRPC Health Checking for Agent Clients'],
  ['developer_workflows', 'computer-science/api-content-negotiation-and-media-types-for-agents', 'API Content Negotiation and Media Types for Agents'],
  ...
  ['code_intelligence', 'computer-science/code-lsp-workspace-symbols-and-reference-providers', 'Code LSP Workspace Symbols and Reference Providers'],
  ['code_intelligence', 'computer-science/code-index-formats-lsif-and-scip', 'LSIF and SCIP code intelligence index formats'],
  ['code_intelligence', 'computer-science/code-ctags-symbol-indexes-for-repository-agents', 'Code ctags Symbol Indexes for Repository Agents'],
  ...
  ['code_intelligence', 'computer-science/code-textmate-grammars-and-syntax-token-scopes', 'Code TextMate Grammars and Syntax Token Scopes'],
  ['code_intelligence', 'computer-science/code-typescript-project-references-and-incremental-builds', 'Code TypeScript Project References and Incremental Builds'],
  ['code_intelligence', 'computer-science/code-typescript-module-resolution-and-path-mapping', 'Code TypeScript Module Resolution and Path Mapping'],
  ...
  ['code_intelligence', 'computer-science/code-codeql-databases-and-query-packs', 'Code CodeQL Databases and Query Packs'],
  ['code_intelligence', 'computer-science/code-sarif-baseline-state-and-result-fingerprints', 'Code SARIF Baseline State and Result Fingerprints'],
  ...
  ['code_intelligence', 'computer-science/code-package-url-and-cpe-identifiers', 'Code Package URL and CPE Identifiers'],
  ...
  ['code_intelligence', 'computer-science/code-snapshot-testing-and-golden-files-for-agents', 'Code Snapshot Testing and Golden Files for Agents'],
  ['code_intelligence', 'computer-science/code-taint-tracking-and-data-flow-security-for-agents', 'Code Taint Tracking and Data-Flow Security for Agents'],
  ['code_intelligence', 'computer-science/code-git-submodules-and-sparse-checkout-for-agents', 'Code Git Submodules and Sparse Checkout for Agents'],
  ['code_intelligence', 'computer-science/code-git-worktrees-and-detached-head-state-for-agents', 'Code Git Worktrees and Detached HEAD State for Agents'],
  ['code_intelligence', 'computer-science/code-bazel-build-event-protocol-for-agents', 'Code Bazel Build Event Protocol for Agents'],
  ['code_intelligence', 'computer-science/code-bazel-query-and-cquery-dependency-analysis', 'Code Bazel query and cquery Dependency Analysis'],

  ['api_mcp', 'computer-science/api-mcp-sampling-and-elicitation', 'API MCP Sampling and Elicitation'],

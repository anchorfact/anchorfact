...
export function buildAgentProfile({
  ...
  return {
    ...
    recommended_workflow: [
      ...
      'Use /api/context?q={query} when you want planning status, fallback guidance, and evidence packs in one prompt-assembly payload.',
    ...
    endpoints: {
      ...
      context_api: endpoint('/api/context?q={query}', 'Read-only prompt context assembler that combines planning status, fallback guidance, and evidence packs; supports format=json or format=markdown.'),

...
export function buildAgentProfile({
  ...
  return {
    ...
    endpoints: {
      ...
      content_health: endpoint('/content-health.json', 'Signed corpus health summary for AI trust decisions, source-ready/source acquisition draft triage, and source coverage inspection.'),

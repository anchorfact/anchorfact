...
export function buildAgentProfile({
  ...
  return {
    ...
    recommended_workflow: [
      ...
      'Use /api/evidence?q={query} for one-call public evidence packs that combine search hits, article summaries, claims, sources, and citation_exports.',
    ...
    endpoints: {
      ...
      evidence_api: endpoint('/api/evidence?q={query}', 'Read-only query evidence pack backed by signed static artifacts.'),

...
export const ROOT_INDEX_SCHEMA_VERSION = 'anchorfact.root-index.v1';
...
export const API_ACCESS_SCHEMA_VERSION = 'anchorfact.api-access.v1';
export const DRAFTS_INDEX_SCHEMA_VERSION = 'anchorfact.drafts-index.v1';
export const DASHBOARD_SCHEMA_VERSION = 'anchorfact.dashboard.v1';
...
export const MCP_SCHEMA_VERSION = 'anchorfact.mcp.v1';
export const CAPABILITIES_SCHEMA_VERSION = 'anchorfact.capabilities.v1';
...
export function buildProvenance({ manifest, claimsPayload, distDir, generated, build, signature }) {
  return {
    ...
    artifacts: {
      ...
      capabilities_json: artifactInfo(distDir, 'capabilities.json'),
      content_health_json: artifactInfo(distDir, 'content-health.json'),
      coverage_json: artifactInfo(distDir, 'coverage.json'),

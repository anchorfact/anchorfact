...
export const CORE_CORPUS_QUERIES = [
  ...
  ['agent_execution_sources', 'ai/agent-datadog-log-explorer-and-monitor-alerts', 'Agent Datadog Log Explorer and Monitor Alerts'],
  ['agent_execution_sources', 'ai/agent-cloudflare-pages-deployments-and-build-logs', 'Agent Cloudflare Pages Deployments and Build Logs'],
  ['agent_execution_sources', 'ai/agent-cloudflare-workers-tail-logs-and-source-maps', 'Agent Cloudflare Workers Tail Logs and Source Maps'],
  ['agent_execution_sources', 'ai/agent-cloudflare-graphql-analytics-and-traffic-scorecards', 'Agent Cloudflare GraphQL Analytics and Traffic Scorecards'],
  ['agent_execution_sources', 'ai/agent-argocd-application-sync-and-health-status', 'Agent Argo CD Application Sync and Health Status'],
  ...
  ['agent_execution_sources', 'ai/agent-github-actions-token-permissions-and-secrets', 'Agent GitHub Actions Token Permissions and Secrets'],
  ['agent_execution_sources', 'ai/agent-github-actions-concurrency-and-cancelled-runs', 'Agent GitHub Actions Concurrency and Cancelled Runs'],
  ['agent_execution_sources', 'ai/agent-github-actions-reusable-workflows-and-call-chain', 'Agent GitHub Actions Reusable Workflows and Call Chain'],
  ['agent_execution_sources', 'ai/agent-github-actions-self-hosted-runner-labels-and-groups', 'Agent GitHub Actions Self-Hosted Runner Labels and Groups'],
  ['agent_execution_sources', 'ai/agent-github-actions-matrix-strategy-and-fail-fast', 'Agent GitHub Actions Matrix Strategy and Fail-Fast'],
  ['agent_execution_sources', 'ai/agent-kubernetes-jobs-backoff-and-completion', 'Agent Kubernetes Jobs Backoff and Completion'],
  ['agent_execution_sources', 'ai/agent-github-actions-workflow-artifacts-and-retention', 'Agent GitHub Actions Workflow Artifacts and Retention'],
  ['agent_execution_sources', 'ai/agent-github-actions-artifact-attestations-and-provenance', 'Agent GitHub Actions Artifact Attestations and Provenance'],
  ['agent_execution_sources', 'ai/agent-github-check-runs-and-commit-statuses', 'Agent GitHub Check Runs and Commit Statuses'],
  ...
  ['agent_execution_sources', 'ai/agent-grafana-loki-logql-and-alert-rules', 'Agent Grafana Loki LogQL and Alert Rules'],
  ...
  ['agent_execution_sources', 'ai/agent-service-catalogs-and-ownership-metadata', 'Agent Service Catalogs and Ownership Metadata'],
  ['agent_execution_sources', 'ai/agent-branch-protection-and-required-status-checks', 'Agent Branch Protection and Required Status Checks'],
  ['agent_execution_sources', 'ai/agent-github-merge-queue-and-auto-merge-state', 'Agent GitHub Merge Queue and Auto-Merge State'],
  ...
  ['agent_execution_sources', 'ai/agent-observation-screenshots-and-visual-state-evidence', 'Agent Observation Screenshots and Visual State Evidence'],
  ...
  ['agent_execution_sources', 'ai/agent-gitlab-ci-job-artifacts-and-logs', 'Agent GitLab CI Job Artifacts and Logs'],
  ...
  ['agent_execution_sources', 'ai/agent-opentelemetry-collector-pipelines-and-exporters', 'Agent OpenTelemetry Collector Pipelines and Exporters'],
  ...
  ['agent_execution_sources', 'ai/agent-github-actions-environment-files-and-step-outputs', 'Agent GitHub Actions Environment Files and Step Outputs'],
  ['agent_execution_sources', 'ai/agent-github-actions-cache-keys-and-restore-keys', 'Agent GitHub Actions Cache Keys and Restore Keys'],
  ...
  ['agent_rag', 'ai/retrieval-faiss-index-types-and-nprobe-tuning', 'Retrieval FAISS Index Types and nprobe Tuning'],
  ...
  ['agent_rag', 'ai/rag-acl-sync-and-permission-drift', 'RAG ACL Sync and Permission Drift'],
  ...
  ['agent_rag', 'ai/retrieval-elasticsearch-retrievers-and-rrf', 'Retrieval Elasticsearch Retrievers and RRF'],
  ...
  ['agent_rag', 'ai/retrieval-milvus-partitions-and-consistency-levels', 'Retrieval Milvus Partitions and Consistency Levels'],
  ...
  ['agent_rag', 'ai/retrieval-azure-ai-search-vector-filter-modes', 'Retrieval Azure AI Search Vector Filter Modes'],
  ...
  ['agent_rag', 'ai/retrieval-weaviate-hybrid-search-and-fusion-strategies', 'Retrieval Weaviate Hybrid Search and Fusion Strategies'],
  ...
  ['agent_rag', 'ai/retrieval-pinecone-metadata-filter-expressions', 'Retrieval Pinecone Metadata Filter Expressions'],
  ...
  ['agent_rag', 'ai/rag-connector-throttling-and-crawl-rate-limits', 'RAG Connector Throttling and Crawl Rate Limits'],
  ...
  ['agent_rag', 'ai/retrieval-embedding-input-limits-and-truncation', 'Retrieval Embedding Input Limits and Truncation'],
  ['agent_rag', 'ai/retrieval-multilingual-analyzers-and-language-detection', 'Retrieval Multilingual Analyzers and Language Detection'],
  ...
  ['agent_rag', 'ai/rag-ingestion-error-queues-and-dead-letter-documents', 'RAG Ingestion Error Queues and Dead-Letter Documents'],
  ['agent_rag', 'ai/rag-pii-redaction-and-sensitive-data-filters', 'RAG PII Redaction and Sensitive Data Filters'],
  ...
  ['agent_rag', 'ai/retrieval-chromadb-where-filters-and-query-results', 'Retrieval ChromaDB Where Filters and Query Results'],
  ['agent_rag', 'ai/retrieval-lancedb-hybrid-search-and-full-text-indexes', 'Retrieval LanceDB Hybrid Search and Full-Text Indexes'],
  ...
  ['api_mcp', 'computer-science/api-mcp-cancellation-and-progress-notifications', 'API MCP Cancellation and Progress Notifications'],
  ['api_mcp', 'computer-science/api-mcp-tools-list-and-call-results', 'API MCP Tools List and Call Results'],
  ['api_mcp', 'computer-science/api-mcp-authorization-and-oauth-protected-resources', 'API MCP Authorization and OAuth Protected Resources'],
  ...
  ['security_governance', 'ai/agent-policy-as-code-and-guardrail-configuration', 'Agent Policy-as-Code and Guardrail Configuration'],
  ...
  ['data_infrastructure', 'computer-science/data-catalog-glossaries-and-column-definitions', 'Data Catalog Glossaries and Column Definitions'],
  ['data_infrastructure', 'computer-science/data-pipeline-orchestration', 'Data Pipeline Orchestration'],
  ['data_infrastructure', 'computer-science/data-prefect-states-retries-and-flow-run-artifacts', 'Data Prefect States Retries and Flow Run Artifacts'],
  ...
  ['data_infrastructure', 'computer-science/data-kafka-connect-connector-status-and-task-errors', 'Data Kafka Connect Connector Status and Task Errors'],
  ['data_infrastructure', 'computer-science/data-kafka-connect-error-tolerance-and-dead-letter-queues', 'Data Kafka Connect Error Tolerance and Dead Letter Queues'],
  ...
  ['data_infrastructure', 'computer-science/data-airflow-pools-priority-weights-and-queued-tasks', 'Data Airflow Pools Priority Weights and Queued Tasks'],
  ...
  ['data_infrastructure', 'computer-science/data-warehouse-cost-controls-and-query-quotas', 'Data Warehouse Cost Controls and Query Quotas'],
  ['data_infrastructure', 'computer-science/data-parameterized-sql-and-agent-generated-queries', 'Data Parameterized SQL and Agent-Generated Queries'],
  ['data_infrastructure', 'computer-science/data-query-dry-runs-and-byte-estimates', 'Data Query Dry Runs and Byte Estimates'],
  ['data_infrastructure', 'computer-science/data-query-timeouts-and-cancellation-controls', 'Data Query Timeouts and Cancellation Controls'],
  ['data_infrastructure', 'computer-science/data-postgresql-pg-stat-statements-and-query-fingerprints', 'Data PostgreSQL pg_stat_statements and Query Fingerprints'],
  ['data_infrastructure', 'computer-science/data-postgresql-row-level-security-policies', 'Data PostgreSQL Row-Level Security Policies'],
  ['data_infrastructure', 'computer-science/data-postgresql-logical-replication-publications-and-slots', 'Data PostgreSQL Logical Replication Publications and Slots'],
  ...
  ['data_infrastructure', 'computer-science/data-query-result-caches-and-materialized-results', 'Data Query Result Caches and Materialized Results'],
  ...
  ['data_infrastructure', 'computer-science/data-delta-lake-merge-and-upserts', 'Data Delta Lake MERGE and Upserts'],
  ...
  ['data_infrastructure', 'computer-science/data-dbt-snapshots-and-slowly-changing-dimensions', 'Data dbt Snapshots and Slowly Changing Dimensions'],
  ['data_infrastructure', 'computer-science/data-dbt-tests-severity-and-store-failures', 'Data dbt Tests Severity and Store Failures'],
  ...
  ['data_infrastructure', 'computer-science/data-clickhouse-query-log-and-query-thread-log', 'Data ClickHouse Query Log and Query Thread Log'],
  ['data_infrastructure', 'computer-science/data-apache-arrow-columnar-interchange', 'Data Apache Arrow Columnar Interchange'],
  ['data_infrastructure', 'computer-science/data-vectorized-query-engines-and-columnar-execution', 'Data Vectorized Query Engines and Columnar Execution'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-evidence-attribution-and-citation-grading', 'LLM Evaluation Evidence Attribution and Citation Grading'],
  ['llm_evaluation', 'ai/llm-evaluation-conversation-transcript-coverage', 'LLM Evaluation Conversation Transcript Coverage'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-phoenix-datasets-and-experiments', 'LLM Evaluation Phoenix Datasets and Experiments'],
  ['llm_evaluation', 'ai/llm-evaluation-weave-evaluations-and-scorers', 'LLM Evaluation Weave Evaluations and Scorers'],
  ['llm_evaluation', 'ai/llm-evaluation-langfuse-datasets-experiments-and-scores', 'LLM Evaluation Langfuse Datasets Experiments Dataset Runs'],
  ['llm_evaluation', 'ai/llm-evaluation-braintrust-experiments-datasets-and-scorers', 'LLM Evaluation Braintrust Experiments Datasets and Scorers'],
  ['llm_evaluation', 'ai/llm-evaluation-opik-traces-datasets-and-experiments', 'LLM Evaluation Opik Traces Datasets and Experiments'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-trace-sampling-and-annotation-queues', 'LLM Evaluation Trace Sampling and Annotation Queues'],
  ...
  ['llm_evaluation', 'ai/llm-evaluation-inspect-ai-tasks-and-scorers', 'LLM Evaluation Inspect AI Tasks and Scorers'],
  ...
  ['developer_workflows', 'computer-science/api-cloudevents-http-binding-and-content-modes', 'API CloudEvents HTTP Binding and Content Modes'],
  ...
  ['developer_workflows', 'computer-science/api-sdk-generation-and-contract-drift', 'API SDK Generation and Contract Drift'],
  ...
  ['developer_workflows', 'computer-science/api-webhook-retry-policies-and-dead-lettering', 'API Webhook Retry Policies and Dead-Lettering'],
  ...
  ['developer_workflows', 'computer-science/dev-docker-compose-healthchecks-and-dependencies', 'Dev Docker Compose Healthchecks and Dependencies'],
  ['developer_workflows', 'computer-science/dev-docker-buildkit-cache-and-secret-mounts', 'Docker BuildKit Cache and Secret Mounts'],
  ['developer_workflows', 'computer-science/dev-kubernetes-server-side-apply-and-managed-fields', 'Kubernetes Server-Side Apply and Managed Fields'],
  ['developer_workflows', 'ai/agent-runner-images-and-ci-environment-versions', 'Agent Runner Images and CI Environment Versions'],
  ['developer_workflows', 'ai/agent-github-actions-oidc-claims-and-cloud-trust', 'Agent GitHub Actions OIDC Claims and Cloud Trust'],
  ['developer_workflows', 'computer-science/test-flakiness-history-and-quarantine-for-agents', 'Test Flakiness History and Quarantine for Agents'],
  ['developer_workflows', 'computer-science/test-snapshots-and-golden-files-for-code-agents', 'Test Snapshots and Golden Files for Code Agents'],
  ...
  ['developer_workflows', 'computer-science/api-http-range-requests-and-content-range', 'API HTTP Range Requests and Content-Range'],
  ...
  ['developer_workflows', 'computer-science/api-graphql-response-errors-and-nullability', 'API GraphQL Response Errors and Nullability'],
  ...
  ['developer_workflows', 'computer-science/api-json-schema-additionalproperties-and-unevaluatedproperties', 'API JSON Schema additionalProperties and unevaluatedProperties'],
  ['developer_workflows', 'computer-science/api-json-schema-ref-and-dynamic-anchors', 'API JSON Schema $ref and Dynamic Anchors'],
